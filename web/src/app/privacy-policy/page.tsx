const PrivacyPolicy = () => {
  return (
    <main className="max-w-2xl flex flex-col justify-center items-center gap-12 text-lg py-20">
      <strong className="text-2xl">Privacy Policy</strong>
      <p>
        This privacy policy applies to the FixSleep app (hereby referred to as
        &quot;Application&quot;) for mobile devices that was created by Falilou
        Khouma (hereby referred to as &quot;Service Provider&quot;) as a
      ...
      <p>
        ...
        use the Application and for a reasonable time thereafter. If you&lsquo;d
        like them to delete User Provided Data that you have provided via the
        Application, please contact them at falukhouma27@gmail.com and they will
      ...
      <div>
        ...
        <p>
          ...
          the Service Provider (falukhouma27@gmail.com) so that they will be
      ...
      <br />
      <p>This privacy policy is effective as of 2025-05-12</p>
      <br />
      ...
      <p>
        ...
        Provider via email at falukhouma27@gmail.com.
      </p>
    </main>
  );
};
