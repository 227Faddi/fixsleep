const Terms = () => {
  return (
    <main className="max-w-2xl flex flex-col justify-center items-center gap-12 text-lg py-20">
      <strong className="text-2xl">Terms &amp; Conditions</strong>
      <br />
      <p>
        These terms and conditions apply to the FixSleep app (hereby referred to
        as &quot;Application&quot;) for mobile devices that was created by
        Falilou Khouma (hereby referred to as &quot;Service Provider&quot;) as a
        Freemium service.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>These terms and conditions are effective as of 2025-05-12</p>
      <br />
